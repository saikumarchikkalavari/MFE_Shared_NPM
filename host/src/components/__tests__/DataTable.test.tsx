/**
 * DataTable Component Test Suite - From Shared Library
 * 
 * Comprehensive tests for the DataTable component using AG Grid React.
 * Tests 17+ different scenarios without mocks.
 */
...
import { DataTable } from '@mfe/shared-lib';
...
describe('DataTable Component Tests - Shared Library', () => {
